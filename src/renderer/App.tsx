    ...
    <div className="rootDiv">
      <div className="side-bar">
        <div className="nav">
          <div className="guildSettings">
            <div className="navguild">
              <div className="guild-opener">
                <div className="navGuildItems">
                  <h4 className="guildSelectorName">Server Name</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="servers">
        ...
        <div className="server active">
          <p className="servericon">SN</p>
        </div>
        <div className="server">
          <p className="servericon">S1</p>
        </div>
        <div className="server">
          <p className="servericon unread">S2</p>
        </div>
        <div className="server">
          <img className="servericon" src="https://cdn.discordapp.com/embed/avatars/0.png" />
        </div>
        <div className="server">
          <img className="servericon unread" src="https://cdn.discordapp.com/embed/avatars/1.png" />
        </div>
        <div className="server">
          <img className="servericon" src="https://cdn.discordapp.com/embed/avatars/2.png" />
        </div>
        <div className="server">
          <img className="servericon" src="https://cdn.discordapp.com/embed/avatars/3.png" />
        </div>
        <div className="server">
          <img className="servericon" src="https://cdn.discordapp.com/embed/avatars/4.png" />
        </div>
        <div className="server invite">
          <p className="inviteButton">+</p>
        </div>
      </div>
